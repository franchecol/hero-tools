...
LDFLAGS  += -hero$(NUM_DEVICES)-lclang_rt.builtins-riscv32
# Runtime
CFLAGS   += -hero$(NUM_DEVICES)-I$(CARFIELD_ROOT)/sw/tests/bare-metal/snitchd/runtime
LDFLAGS  += -hero$(NUM_DEVICES)-T$(CARFIELD_ROOT)/sw/tests/bare-metal/snitchd/runtime/link.ld
