...
s11_ip="${repo_root}/fpga/de1-soc/sl11_snitch_hps_payload_loader/ip/s11_snitch_payload"
project=de1_s11_snitch_hps_payload_loader
system=s11_hps_snitch_system
...
# SL11 uses only the lightweight bridge. Do not run stale HPS SDRAM constraints
