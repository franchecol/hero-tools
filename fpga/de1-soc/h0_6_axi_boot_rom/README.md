...
four-instruction payload while preserving this AXI target. H2 supersedes the
fixed ROM with host-writable boot RAM while retaining the same Snitch-side AXI
address and burst contract.
