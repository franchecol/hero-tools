...
set_module_property NAME d3_mmio_regs
set_module_property DISPLAY_NAME "D3 HPS MMIO Register Accelerator"
set_module_property VERSION 1.0
set_module_property GROUP "DE1-SoC Bring-Up"
set_module_property AUTHOR "hero-tools local"
set_module_property DESCRIPTION "Small Avalon-MM register block used by the D3 HPS lightweight-bridge MMIO test."
...
proc fileset_quartus_synth {output_name} {
    ...
    add_fileset_file rtl/d3_mmio_regs.v VERILOG PATH rtl/d3_mmio_regs.v
}
