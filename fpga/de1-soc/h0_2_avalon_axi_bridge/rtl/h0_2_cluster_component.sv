module h0_2_cluster_component_core #(
  ...
  input  logic                       boot_host_write,
  input  logic [9:0]                 boot_host_word_addr,
  input  logic [31:0]                boot_host_wdata,
  input  logic [3:0]                 boot_host_be,
  input  logic                       data_host_write,
  input  logic [9:0]                 data_host_word_addr,
  ...
  h0_1_upstream_cluster_shell i_cluster_shell (
    ...
    .boot_host_write_i(boot_host_write), .boot_host_word_addr_i(boot_host_word_addr),
    .boot_host_wdata_i(boot_host_wdata), .boot_host_be_i(boot_host_be),
    .data_host_write_i(data_host_write),
    ...
    .boot_result_valid_o(boot_result_valid), .boot_result_o(boot_result)
  );
endmodule
