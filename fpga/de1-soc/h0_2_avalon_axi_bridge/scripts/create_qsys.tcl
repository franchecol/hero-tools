...
create_system h0_2_upstream_hps_system

set_project_property DEVICE_FAMILY "Cyclone V"
set_project_property DEVICE 5CSEMA5F31C6

add_instance clk_bridge altera_clock_bridge
set_instance_parameter_value clk_bridge EXPLICIT_CLOCK_RATE 20000000
...
add_instance upstream_cluster h0_2_cluster_component

add_connection clk_bridge.out_clk reset_bridge.clk
add_connection clk_bridge.out_clk hps_0.h2f_lw_axi_clock
add_connection clk_bridge.out_clk upstream_cluster.clk
add_connection reset_bridge.out_reset upstream_cluster.reset

add_connection hps_0.h2f_lw_axi_master upstream_cluster.s1
set_connection_parameter_value hps_0.h2f_lw_axi_master/upstream_cluster.s1 baseAddress 0x0000
lock_avalon_base_address upstream_cluster.s1

set_interface_property clk EXPORT_OF clk_bridge.in_clk
set_interface_property reset EXPORT_OF reset_bridge.in_reset

save_system h0_2_upstream_hps_system.qsys
