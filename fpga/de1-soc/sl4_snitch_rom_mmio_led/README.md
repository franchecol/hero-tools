# Snitch-Lite SL4: ROM To MMIO LED

SL4 is the first DE1-SoC stage where the real upstream Snitch core is connected
...
```bash
cd /home/ftv/builds/hero-tools/fpga/de1-soc/sl4_snitch_rom_mmio_led
...
If the build and board test pass, SL4 proves:
...
unused behavior. It is stronger than SL3 because the LED value now depends on a
...
After SL4, the next useful stage is to replace the hardcoded ROM with a build
