...
set_module_property NAME s10_snitch_data
set_module_property DISPLAY_NAME "SL10 Snitch-Lite HPS Host Data Input"
set_module_property VERSION 1.0
set_module_property GROUP "DE1-SoC Bring-Up"
set_module_property AUTHOR "hero-tools local"
set_module_property DESCRIPTION "HPS-ready Avalon-MM control/status/data block around Snitch-Lite."
...
proc wrapper_text {output_name} {
    ...
    s10_snitch_host_data_core u_core (
        .clk             (clk),
        .reset           (reset),
...
proc fileset_quartus_synth {output_name} {
    ...
    add_fileset_file generated/snitch_host_data_core.v VERILOG PATH ../../generated/snitch_host_data_core.v
}
