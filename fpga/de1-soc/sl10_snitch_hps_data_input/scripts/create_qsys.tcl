...
create_system s10_hps_snitch_system
...
add_instance snitch_data s10_snitch_data

add_connection clk_bridge.out_clk reset_bridge.clk
add_connection clk_bridge.out_clk hps_0.h2f_lw_axi_clock
add_connection clk_bridge.out_clk snitch_data.clk

add_connection reset_bridge.out_reset snitch_data.reset

add_connection hps_0.h2f_lw_axi_master snitch_data.s1
set_connection_parameter_value hps_0.h2f_lw_axi_master/snitch_data.s1 baseAddress 0x0000
lock_avalon_base_address snitch_data.s1

set_interface_property clk EXPORT_OF clk_bridge.in_clk
set_interface_property reset EXPORT_OF reset_bridge.in_reset
set_interface_property ledr EXPORT_OF snitch_data.ledr

save_system s10_hps_snitch_system.qsys
