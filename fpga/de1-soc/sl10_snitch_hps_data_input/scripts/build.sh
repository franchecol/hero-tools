...
s10_ip="${repo_root}/fpga/de1-soc/sl10_snitch_hps_data_input/ip/s10_snitch_data"
project=de1_s10_snitch_hps_data_input
system=s10_hps_snitch_system
...
# SL10 uses only the lightweight bridge. Do not run stale HPS SDRAM constraints
