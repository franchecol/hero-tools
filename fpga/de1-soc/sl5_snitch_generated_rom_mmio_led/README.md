# Snitch-Lite SL5: Generated Software ROM To MMIO LED

SL5 keeps the SL4 hardware behavior but removes the hardcoded instruction words
from the RTL.
...
```bash
cd /home/ftv/builds/hero-tools/fpga/de1-soc/sl5_snitch_generated_rom_mmio_led
...
If the build and board test pass, SL5 proves:
...
After SL5, the next useful step is to make the ROM generator more general:
