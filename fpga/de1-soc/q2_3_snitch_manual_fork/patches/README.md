# Q2.3 Manual Patch Diffs

This folder records line-level diffs between the original Snitch checkout used
by Occamy and the manually edited Q2.3 fork.

These files exist because the Q2.3 fork was imported into `hero-tools` after
the first manual edits. In a normal Git commit view, many Q2.3 source files look
like whole-file additions because Git had no previous committed version of those
files inside `fpga/de1-soc/q2_3_snitch_manual_fork/`.
...
vs.
Q2.3 manually edited Snitch source
```
...
attempt1_sram_type_parameter_port.patch
  Documents the first manual Q2.3 change:
...
fork=fpga/de1-soc/q2_3_snitch_manual_fork/snitch_cluster
