...
package snitch_cluster_pkg;
  ...
  localparam snitch_ssr_pkg::ssr_cfg_t [3-1:0] SsrCfgs [1] = '{
    '{'{0, 0, 0, 0, 1, 1, 4, 11, 14, 3, 4, 3, 8, 4, 3},
      '{0, 0, 0, 0, 1, 1, 4, 11, 14, 3, 4, 3, 8, 4, 3},
      '{0, 0, 0, 0, 1, 1, 4, 11, 14, 3, 4, 3, 8, 4, 3}}
  };
...
module snitch_cluster_wrapper (
  ...
  localparam int unsigned NumIntOutstandingMem [1] = '{2};
  localparam int unsigned NumFPOutstandingLoads [1] = '{1};
  localparam int unsigned NumFPOutstandingMem [1] = '{1};
  localparam int unsigned NumDTLBEntries [1] = '{1};
  localparam int unsigned NumITLBEntries [1] = '{1};
  localparam int unsigned NumSequencerInstr [1] = '{4};
