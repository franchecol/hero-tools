# U2: Genus Snitch Core Uses Local Data RAM

U2 extends the U0/U1 external-synthesis path with the missing load-response
...
U0 and U1 tied the Snitch data response to `p_valid=0`. Stores remained
...
software re-execution behavior. This completes U2.
