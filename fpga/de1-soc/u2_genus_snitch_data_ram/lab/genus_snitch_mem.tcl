set TOP snitch_genus_mem_probe
...
set SOURCES [list \
  ...
  [file join $ROOT snitch_genus_mem_probe.sv] \
]
...
write_hdl > snitch_mem_elaborated.v
report gates > snitch_mem_elaborated_gates.rpt

syn_generic
write_hdl > snitch_mem_generic_netlist.v
report gates > snitch_mem_generic_gates.rpt

syn_map
write_hdl > snitch_mem_genus_netlist.v
report gates > snitch_mem_mapped_gates.rpt
report area > snitch_mem_area.rpt
report timing > snitch_mem_timing.rpt
