# Q2: Direct Quartus Upstream-Wrapper Preflight

Q2 starts the DE1-SoC Quartus-facing path for the reduced real Snitch target.

Q0 proved the generated real Snitch RTL can boot and execute a tiny program in
Verilator. Q1 proved the same target can issue a peripheral-style store. Q2
...
```text
cfg/one-core.hjson
  Reduced one-core Snitch config reused from Q0/Q1.
...
So Q2 currently proves that the project packaging path works, but the unmodified
...
## Why This Is Not Yet SL3

SL3 should connect Snitch-visible behavior to board-visible LED/UART/register
logic. Q2 first checks whether Quartus can even accept the generated Snitch RTL
package.
