# S17: Direct Genus Snitch-Core Probe

S17 is the first escalation after the S16 toy gate-level import passed on the
physical DE1-SoC.
...
already translated S3 Verilog to Genus would not test whether Genus solves the
...
constant-NOP shell measured by S3.
...
```text
S16 physical toy proof:                  PASS
Pinned Snitch repository on lab server: PASS
Pinned common_cells on lab server:      PASS
S17 direct Genus elaboration:            PASS
S17 generic synthesis:                   PASS
S17 TSMC65 mapping:                      PASS
S17 mapped cell instances:               3296
S17 mapped cell area:                    12413.520
S17 mapped netlist size:                 447 KiB
S17 Questa gate-level simulation:        PASS
S17 valid fetches observed:               16
S17 highest fetch address:                0x40
S17 Questa errors/warnings:               0 / 0
S17 Quartus generic import:                PASS
S17 Quartus resources:                     1216 ALMs / 988 registers
S17 Quartus 50 MHz worst setup slack:      0.244 ns
S17 JTAG programming:                      PASS
S17 physical LED/reset observation:        PASS
```
...
S16's hand-written shim method for every cell would be brittle and would mix
