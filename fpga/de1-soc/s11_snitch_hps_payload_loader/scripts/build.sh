...
s11_ip="${repo_root}/fpga/de1-soc/s11_snitch_hps_payload_loader/ip/s11_snitch_payload"
...
# S11 uses only the lightweight bridge. Do not run stale HPS SDRAM constraints
