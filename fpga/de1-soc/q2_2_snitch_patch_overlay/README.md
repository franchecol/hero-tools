# Q2.2 Original Snitch Patch Overlay Experiment

This experiment continues from Q2 without using `sv2v` or any other
translation tool.
...
Q2 proved that the unmodified generated Snitch cluster can be exported as a
