...
def main():
    ...
    with args.header.open("w", encoding="utf-8") as f:
        f.write("#ifndef S13_PAYLOAD_WORDS_H\n")
        f.write("#define S13_PAYLOAD_WORDS_H\n\n")
        f.write(f"#define S13_PAYLOAD_WORD_COUNT {len(words)}u\n")
        f.write(f"#define S13_PAYLOAD_MAX_WORDS {args.max_words}u\n\n")
        f.write("static const u32 s13_payload_words[S13_PAYLOAD_WORD_COUNT] = {\n")
        for word in words:
