...
create_system s13_hps_snitch_irq_system
...
add_instance snitch_payload s13_snitch_irq_payload

add_connection clk_bridge.out_clk reset_bridge.clk
add_connection clk_bridge.out_clk hps_0.h2f_lw_axi_clock
add_connection clk_bridge.out_clk snitch_payload.clk

add_connection reset_bridge.out_reset snitch_payload.reset

add_connection hps_0.h2f_lw_axi_master snitch_payload.s1
set_connection_parameter_value hps_0.h2f_lw_axi_master/snitch_payload.s1 baseAddress 0x0000
lock_avalon_base_address snitch_payload.s1

add_connection hps_0.f2h_irq0 snitch_payload.irq

set_interface_property clk EXPORT_OF clk_bridge.in_clk
set_interface_property reset EXPORT_OF reset_bridge.in_reset
set_interface_property ledr EXPORT_OF snitch_payload.ledr

save_system s13_hps_snitch_irq_system.qsys
