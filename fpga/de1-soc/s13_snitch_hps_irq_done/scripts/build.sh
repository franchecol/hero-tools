...
s13_ip="${repo_root}/fpga/de1-soc/s13_snitch_hps_irq_done/ip/s13_snitch_irq_payload"
...
# S13 uses only the lightweight bridge. Do not run stale HPS SDRAM constraints
