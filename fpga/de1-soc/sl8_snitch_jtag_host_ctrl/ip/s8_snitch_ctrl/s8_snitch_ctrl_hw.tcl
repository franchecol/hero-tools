...
set_module_property NAME s8_snitch_ctrl
set_module_property DISPLAY_NAME "SL8 Snitch-Lite Host Control"
set_module_property VERSION 1.0
set_module_property GROUP "DE1-SoC Bring-Up"
set_module_property AUTHOR "hero-tools local"
set_module_property DESCRIPTION "JTAG/HPS-ready Avalon-MM control/status block around the Snitch-Lite RAM check."
