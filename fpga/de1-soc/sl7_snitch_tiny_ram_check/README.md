# Snitch-Lite SL7: Tiny RAM Check

SL7 extends SL6 from "Snitch can write MMIO" to "Snitch can store to local data
...
```bash
cd /home/ftv/builds/hero-tools/fpga/de1-soc/sl7_snitch_tiny_ram_check
...
If the build and board test pass, SL7 proves:
...
After SL7, the next likely step is SL8: add a minimal host-visible control/status
