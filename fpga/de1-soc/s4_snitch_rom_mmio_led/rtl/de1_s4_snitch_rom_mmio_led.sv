package de1_s4_snitch_rom_mmio_led_pkg;
...
module de1_s4_snitch_rom_mmio_led (
    input  logic       CLOCK_50,
    input  logic [3:0] KEY,
    output logic [9:0] LEDR
);
    import snitch_pkg::*;
    import de1_s4_snitch_rom_mmio_led_pkg::*;
    ...
    //   jal  zero, 0           # stay here
    always_comb begin
        unique case (inst_addr[5:2])
            4'd0: inst_data = 32'h4000_02b7;
            4'd1: inst_data = 32'h1550_0313;
            4'd2: inst_data = 32'h0062_a023;
            4'd3: inst_data = 32'h0000_006f;
            default: inst_data = 32'h0000_006f;
        endcase
    end
    ...
    always_ff @(posedge CLOCK_50 or posedge rst_i) begin
        if (rst_i) begin
            ...
            if (data_q_fire) begin
                ...
                data_rsp_error_q <= 1'b0;
                data_rsp_data_q  <= (mmio_access && !data_req.q.write)
                                  ? {{22{1'b0}}, led_reg_q}
                                  : '0;
