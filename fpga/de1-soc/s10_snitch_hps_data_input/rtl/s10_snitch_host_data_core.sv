package s10_snitch_host_data_core_pkg;
...
module s10_snitch_host_data_core (
    input  logic        clk,
    input  logic        reset,
    ...
    import snitch_pkg::*;
    import s10_snitch_host_data_core_pkg::*;

    `include "rom_words.svh"

    localparam logic [31:0] ID_VALUE = 32'h5310_0001;
    ...
    localparam logic [3:0] REG_ARG0        = 4'h8;
    localparam logic [3:0] REG_ARG1        = 4'h9;
    localparam logic [3:0] REG_EXPECTED    = 4'ha;
    localparam logic [3:0] REG_RAM1        = 4'hb;
    localparam logic [3:0] REG_RAM2        = 4'hc;
    ...
    always_comb begin
        inst_data = s10_rom_word({2'b0, inst_addr[31:2]});
    end
    ...
    always_comb begin
        unique case (avs_address)
            ...
            REG_ROM_WORDS:   avs_readdata = S10_ROM_WORDS;
