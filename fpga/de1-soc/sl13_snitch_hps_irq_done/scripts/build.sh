...
s13_ip="${repo_root}/fpga/de1-soc/sl13_snitch_hps_irq_done/ip/s13_snitch_irq_payload"
project=de1_s13_snitch_hps_irq_done
system=s13_hps_snitch_irq_system
...
# SL13 uses only the lightweight bridge. Do not run stale HPS SDRAM constraints
