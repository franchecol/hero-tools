...
set_module_property NAME s13_snitch_irq_payload
set_module_property DISPLAY_NAME "SL13 Snitch-Lite HPS Payload Loader"
set_module_property VERSION 1.0
set_module_property GROUP "DE1-SoC Bring-Up"
set_module_property AUTHOR "hero-tools local"
set_module_property DESCRIPTION "HPS-ready Avalon-MM payload loader around Snitch-Lite."
...
proc wrapper_text {output_name} {
    ...
    s13_snitch_irq_payload_core u_core (
        .clk             (clk),
        .reset           (reset),
...
proc fileset_quartus_synth {output_name} {
    ...
    add_fileset_file generated/snitch_host_payload_core.v VERILOG PATH ../../generated/snitch_host_payload_core.v
}
...
set_interface_property s1 explicitAddressSpan 512
