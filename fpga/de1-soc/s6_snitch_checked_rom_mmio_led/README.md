# Snitch-Lite S6: Checked Generated ROM

S6 keeps the S5 software-generated ROM behavior and makes the ROM generation
flow safer.
...
S6 adds checks around that path:
...
```bash
cd /home/ftv/builds/hero-tools/fpga/de1-soc/s6_snitch_checked_rom_mmio_led
...
If the build and board test pass, S6 proves:

```text
The generated ROM flow is safer than S5.
...
After S6, the next hardware step is S7: add a tiny data RAM so Snitch can
