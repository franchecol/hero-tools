package de1_s6_snitch_checked_rom_mmio_led_pkg;
...
module de1_s6_snitch_checked_rom_mmio_led (
    input  logic       CLOCK_50,
    input  logic [3:0] KEY,
    output logic [9:0] LEDR
);
    import snitch_pkg::*;
    import de1_s6_snitch_checked_rom_mmio_led_pkg::*;
    ...
    always_comb begin
        inst_data = s6_rom_word({2'b0, inst_addr[31:2]});
    end
