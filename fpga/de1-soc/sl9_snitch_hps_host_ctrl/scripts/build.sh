...
s8_dir="${repo_root}/fpga/de1-soc/sl8_snitch_jtag_host_ctrl"
s9_ip="${repo_root}/fpga/de1-soc/sl9_snitch_hps_host_ctrl/ip/s9_snitch_ctrl"
...
# SL9 uses only the lightweight bridge. Do not run stale HPS SDRAM constraints
